// Aggiungi vicino ogni commento un bottone per cancellarlo (DELETE). 
// Dovrà creare una richiesta versohttps://striveschool-api.herokuapp.com/api/comments/:commentId
